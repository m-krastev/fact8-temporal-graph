...
class TGN(torch.nn.Module):
    ...
    def get_prob(self, src_idx_l, target_idx_l, cut_time_l, edge_idxs=None, logit=False, edge_idx_preserve_list=None, candidate_weights_dict=None):
        """
        ...
        source_node_embedding, destination_node_embedding, negative_node_embedding = self.compute_temporal_embeddings(
            src_idx_l, target_idx_l, negative_nodes, cut_time_l, edge_idxs, self.num_neighbors,
            edge_idx_preserve_list=edge_idx_preserve_list,
            candidate_weights_dict=candidate_weights_dict,
            )
